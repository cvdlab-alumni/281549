...
elements.push(leftLeftWall);

var topLeftWall = T([0,1,2])([1,22,.1])(SIMPLEX_GRID([[8],[.2],[3]]));
elements.push(topLeftWall);
...
elements.push(bottomRightWall);

var rightRightWall = T([0,1,2])([51,5,.1])(SIMPLEX_GRID([[.2],[11.2],[3]]));
elements.push(rightRightWall);
...
elements = elements.concat(glassRestRoomWall);
...
elements = elements.concat(glassUpperExhibitionWall);
...
elements = elements.concat(glassRightExhibitionLittleWall);
...
elements = elements.concat(glassRightExhibitionLargeWall);
